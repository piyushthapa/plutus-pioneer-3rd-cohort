...
mkValidator _ (MyRedeemer flg1 flg2)_ = flg1 == flg2

instance Scripts.ValidatorTypes MyRedeemer where
    -- Implement me!
    type instance DatumType MyRedeemer = ()
    type instance RedeemerType MyRedeemer = MyRedeemer


typedValidator :: Scripts.TypedValidator MyRedeemer
typedValidator = Scripts.mkTypedValidator @MyRedeemer
